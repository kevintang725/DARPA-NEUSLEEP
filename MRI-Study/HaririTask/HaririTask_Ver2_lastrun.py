...
expName = 'HaririTask_Ver2'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\local.BME\\Desktop\\HaririTask\\HaririTask_Ver2_lastrun.py',
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('..\\HaririTask\\HaririTrials_Ver2.csv'),

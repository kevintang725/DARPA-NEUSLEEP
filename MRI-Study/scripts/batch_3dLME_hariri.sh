...
set base_dir = "${root_dir}/IndivAnal/HARIRI"
...
3dLME -prefix ${lme_output} \
    ...
    -gltLabel 2 "Anger_vs_Shapes"     -gltCode 2 'Condition : 1*Anger_Coef -1*Shapes_Coef' \
    -gltLabel 3 "Happy_vs_Shapes"     -gltCode 3 'Condition : 1*Happy_Coef -1*Shapes_Coef' \
    -gltLabel 4 "Neutral_vs_Shapes"   -gltCode 4 'Condition : 1*Neutral_Coef -1*Shapes_Coef' \
    -gltLabel 5 "Fear_vs_Shapes"      -gltCode 5 'Condition : 1*Fear_Coef -1*Shapes_Coef' \
    -gltLabel 6 "SessionXAnger"       -gltCode 6 'Session : 1*FUS -1*Sham Condition : 1*Anger_Coef' \
    -gltLabel 7 "SessionXHappy"       -gltCode 7 'Session : 1*FUS -1*Sham Condition : 1*Happy_Coef' \
    -gltLabel 8 "SessionXNeutral"     -gltCode 8 'Session : 1*FUS -1*Sham Condition : 1*Neutral_Coef' \
    -gltLabel 9 "SessionXFear"        -gltCode 9 'Session : 1*FUS -1*Sham Condition : 1*Fear_Coef' \
    -gltLabel 10 "SessionXShapes"     -gltCode 10 'Session : 1*FUS -1*Sham Condition : 1*Shapes_Coef' \

...
if (! -e ${behavdatadir}/data/sub${subj}_${sess}_Ver2_ShapeTimes_Row.1D) then
echo "Starting behavioral data extraction for ${subj} at sess ${sess} in ${behavdatadir}/data for Hariri Version 2"
set behavdata = `ls|grep "sub${subj}"|grep "HaririTask_Ver2"|grep "trials.csv"`
...
echo "${anger1blockstart} ${anger2blockstart}" >> ${behavdatadir}/data/sub${subj}_${sess}_Ver2_AngerTimes_Row.1D
...
echo "${fear1blockstart} ${fear2blockstart}" >> ${behavdatadir}/data/sub${subj}_${sess}_Ver2_FearTimes_Row.1D
...
echo "${happy1blockstart} ${happy2blockstart}" >> ${behavdatadir}/data/sub${subj}_${sess}_Ver2_HappyTimes_Row.1D
...
echo "${neutral1blockstart} ${neutral2blockstart}" >> ${behavdatadir}/data/sub${subj}_${sess}_Ver2_NeutralTimes_Row.1D
...
echo "${shape1blockstart} ${shape2blockstart}" >> ${behavdatadir}/data/sub${subj}_${sess}_Ver2_ShapeTimes_Row.1D
else
echo "Already found behavioral data extraction for ${subj} at sess ${sessname} in ${behavdatadir}/data for Hariri Version 2.  Not re-running..."
endif
